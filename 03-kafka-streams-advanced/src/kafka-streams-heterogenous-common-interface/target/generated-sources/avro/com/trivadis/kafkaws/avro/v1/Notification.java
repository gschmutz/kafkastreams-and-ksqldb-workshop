...
public class Notification extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1601251530245074926L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Notification\",\"namespace\":\"com.trivadis.kafkaws.avro.v1\",\"fields\":[{\"name\":\"message\",\"type\":[\"null\",\"string\"]}]}");
   ...
   */
  public Notification(java.lang.CharSequence message) {
   ...
   */
  public static com.trivadis.kafkaws.avro.v1.Notification.Builder newBuilder() {
    return new com.trivadis.kafkaws.avro.v1.Notification.Builder();
  }
   ...
   * @return A new Notification RecordBuilder
   */
  public static com.trivadis.kafkaws.avro.v1.Notification.Builder newBuilder(com.trivadis.kafkaws.avro.v1.Notification.Builder other) {
    if (other == null) {
      return new com.trivadis.kafkaws.avro.v1.Notification.Builder();
    } else {
      return new com.trivadis.kafkaws.avro.v1.Notification.Builder(other);
    }
  }
   ...
   * @return A new Notification RecordBuilder
   */
  public static com.trivadis.kafkaws.avro.v1.Notification.Builder newBuilder(com.trivadis.kafkaws.avro.v1.Notification other) {
    if (other == null) {
      return new com.trivadis.kafkaws.avro.v1.Notification.Builder();
    } else {
      return new com.trivadis.kafkaws.avro.v1.Notification.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Notification>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.trivadis.kafkaws.avro.v1.Notification.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.trivadis.kafkaws.avro.v1.Notification other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.message)) {
        this.message = data().deepCopy(fields()[0].schema(), other.message);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.trivadis.kafkaws.avro.v1.Notification.Builder setMessage(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.trivadis.kafkaws.avro.v1.Notification.Builder clearMessage() {
      message = null;
