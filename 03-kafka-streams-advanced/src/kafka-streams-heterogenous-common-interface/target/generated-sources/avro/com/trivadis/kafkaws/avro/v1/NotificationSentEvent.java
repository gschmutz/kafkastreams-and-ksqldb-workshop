...
public class NotificationSentEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord, com.trivadis.kafkaws.kstream.heterogenous.ContextProvider {
  ...
  private static final BinaryMessageEncoder<NotificationSentEvent> ENCODER =
      new BinaryMessageEncoder<NotificationSentEvent>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<NotificationSentEvent> DECODER =
      new BinaryMessageDecoder<NotificationSentEvent>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<NotificationSentEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<NotificationSentEvent>(MODEL$, SCHEMA$, resolver);
  }
