...
public class AlertSentEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3831524274383719466L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AlertSentEvent\",\"namespace\":\"com.trivadis.kafkaws.avro.v2\",\"fields\":[{\"name\":\"context\",\"type\":{\"type\":\"record\",\"name\":\"Context\",\"namespace\":\"com.trivadis.kafkaws.avro.v1\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"when\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}}]}},{\"name\":\"alert\",\"type\":{\"type\":\"record\",\"name\":\"Alert\",\"fields\":[{\"name\":\"alerts\",\"type\":{\"type\":\"array\",\"items\":\"string\"}},{\"name\":\"severity\",\"type\":\"string\"}]}}]}");
  ...
  private com.trivadis.kafkaws.avro.v2.Alert alert;
   ...
   */
  public AlertSentEvent(com.trivadis.kafkaws.avro.v1.Context context, com.trivadis.kafkaws.avro.v2.Alert alert) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: alert = (com.trivadis.kafkaws.avro.v2.Alert)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.trivadis.kafkaws.avro.v2.Alert getAlert() {
    return alert;
  }
   ...
   * @param value the value to set.
   */
  public void setAlert(com.trivadis.kafkaws.avro.v2.Alert value) {
    this.alert = value;
  }
   ...
   */
  public static com.trivadis.kafkaws.avro.v2.AlertSentEvent.Builder newBuilder() {
    return new com.trivadis.kafkaws.avro.v2.AlertSentEvent.Builder();
  }
   ...
   * @return A new AlertSentEvent RecordBuilder
   */
  public static com.trivadis.kafkaws.avro.v2.AlertSentEvent.Builder newBuilder(com.trivadis.kafkaws.avro.v2.AlertSentEvent.Builder other) {
    if (other == null) {
      return new com.trivadis.kafkaws.avro.v2.AlertSentEvent.Builder();
    } else {
      return new com.trivadis.kafkaws.avro.v2.AlertSentEvent.Builder(other);
    }
  }
   ...
   * @return A new AlertSentEvent RecordBuilder
   */
  public static com.trivadis.kafkaws.avro.v2.AlertSentEvent.Builder newBuilder(com.trivadis.kafkaws.avro.v2.AlertSentEvent other) {
    if (other == null) {
      return new com.trivadis.kafkaws.avro.v2.AlertSentEvent.Builder();
    } else {
      return new com.trivadis.kafkaws.avro.v2.AlertSentEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AlertSentEvent>
    ...
    private com.trivadis.kafkaws.avro.v2.Alert alert;
    private com.trivadis.kafkaws.avro.v2.Alert.Builder alertBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.trivadis.kafkaws.avro.v2.AlertSentEvent.Builder other) {
      super(other);
      ...
      if (other.hasAlertBuilder()) {
        this.alertBuilder = com.trivadis.kafkaws.avro.v2.Alert.newBuilder(other.getAlertBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.trivadis.kafkaws.avro.v2.AlertSentEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.context)) {
        this.context = data().deepCopy(fields()[0].schema(), other.context);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.trivadis.kafkaws.avro.v2.AlertSentEvent.Builder setContext(com.trivadis.kafkaws.avro.v1.Context value) {
    ...
    public com.trivadis.kafkaws.avro.v2.AlertSentEvent.Builder setContextBuilder(com.trivadis.kafkaws.avro.v1.Context.Builder value) {
      clearContext();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.trivadis.kafkaws.avro.v2.AlertSentEvent.Builder clearContext() {
      context = null;
      contextBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.trivadis.kafkaws.avro.v2.AlertSentEvent.Builder setAlert(com.trivadis.kafkaws.avro.v2.Alert value) {
     ...
     * @return This builder.
     */
    public com.trivadis.kafkaws.avro.v2.Alert.Builder getAlertBuilder() {
      if (alertBuilder == null) {
        if (hasAlert()) {
          setAlertBuilder(com.trivadis.kafkaws.avro.v2.Alert.newBuilder(alert));
        } else {
          setAlertBuilder(com.trivadis.kafkaws.avro.v2.Alert.newBuilder());
        }
      }
      return alertBuilder;
    }
    ...
    public com.trivadis.kafkaws.avro.v2.AlertSentEvent.Builder setAlertBuilder(com.trivadis.kafkaws.avro.v2.Alert.Builder value) {
      clearAlert();
      alertBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public com.trivadis.kafkaws.avro.v2.AlertSentEvent.Builder clearAlert() {
      alert = null;
      alertBuilder = null;
    ...
    public AlertSentEvent build() {
      try {
        ...
        if (alertBuilder != null) {
          ...
          record.alert = fieldSetFlags()[1] ? this.alert : (com.trivadis.kafkaws.avro.v2.Alert) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
