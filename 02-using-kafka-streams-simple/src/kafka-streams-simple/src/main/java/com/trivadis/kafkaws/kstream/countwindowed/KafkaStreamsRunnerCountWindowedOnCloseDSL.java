...
public class KafkaStreamsRunnerCountWindowedOnCloseDSL {
    ...
    public static void main(String[] args) {
        ...
        config.put(StreamsConfig.COMMIT_INTERVAL_MS_CONFIG, 100); // Commit more frequently
        config.put(StreamsConfig.STATESTORE_CACHE_MAX_BYTES_CONFIG, 0);
        config.put(StreamsConfig.NUM_STREAM_THREADS_CONFIG, 4); // Adjust the number of processing threads
